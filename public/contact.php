...
// /var/www/html/upc_freelance/public/contact.php
// ============================================================
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-5">
                <?php foreach ([
                    ...
                    ['icon'=>'phone',     'title'=>'Téléphone','val'=>'+225 07 XX XX XX XX'],
                    ['icon'=>'location_on','title'=>'Adresse', 'val'=>'Abidjan, Côte d\'Ivoire'],
                ] as $info): ?>
